...
const createPrescription = async (req:Request, res:Response) => {
  try {
    ...
    const createdPrescription = await prescriptionService.createPrescription(prescriptionData);
...
const getSinglePrescription = async (req:Request, res:Response) => {
  ...
  try {
    const prescription = await prescriptionService.getSinglePrescription(prescriptionId);
